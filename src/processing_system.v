...
// ======================================================================
//  Processing system – broadcast each 16-bit sample to all 4 channels
//  • A single sample_in + valid writes the same value into every RAM
//  • After DEPTH samples the block is full → sweep → clear → repeat
// ======================================================================
module processing_system #(
    ...
    wire buffer_full_pulse = sample_in_valid & (wr_addr == DEPTH-1);
