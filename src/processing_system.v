...
module processing_system #(
    ...
    // Debug print for each processing unit
    // always @(posedge clk) begin
    //     if (sample_valid) begin
    //         $display("[PROCESSING UNIT] PU[%0d]: data_in=0x%0h, spike_detection=%b, event_out=%b",
    //             GIDX, proc_word_buf[GIDX], spike_det_int[GIDX], event_out_int[2*GIDX +: 2]);
    //     end
    // end
end
